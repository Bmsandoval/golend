...
import (
	...
	"lendr/internal/controllers/database"
	"lendr/internal/controllers/lenders"
	"lendr/internal/controllers/manage"
	"lendr/internal/controllers/registration"
	"lendr/pkg/middleware"
	"log"
	"net/http"
)
